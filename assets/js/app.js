...
(function () {
  ...
  const PRODUCTS = [
    { id: 'lap-neo14', name: 'NeonBook 14" Ultralight Laptop', category: 'Laptops', price: 899.99, rating: 4.6, image: 'assets/img/laptop.png', desc: '14-inch ultralight with 11th‑gen performance and all‑day battery.', specs: ['14" IPS 1080p','Intel i7','16GB RAM','512GB NVMe','Wi‑Fi 6'] },
    { id: 'phn-xpro', name: 'X‑Pro 5G Smartphone', category: 'Phones', price: 749.00, rating: 4.4, image: 'assets/img/phone.png', desc: 'Flagship camera system with pro video and smooth 120Hz display.', specs: ['6.5" OLED 120Hz','Triple 50MP','8GB RAM','256GB','5G + Wi‑Fi 6E'] },
    { id: 'aud-quiet', name: 'QuietFlow ANC Headphones', category: 'Audio', price: 199.99, rating: 4.3, image: 'assets/img/headphones.png', desc: 'Adaptive noise cancelation with 40hr battery and rich sound.', specs: ['ANC','BT 5.3','40h Battery','USB‑C','Multipoint'] },
    { id: 'cam-vista', name: 'Vista 24MP Mirrorless Camera', category: 'Cameras', price: 1099.00, rating: 4.7, image: 'assets/img/camera.png', desc: 'Stabilized sensor with 4K60 video and vibrant color science.', specs: ['24MP APS‑C','4K60','IBIS','Dual Pixel AF','USB‑C PD'] },
    { id: 'wat-orbit', name: 'Orbit Smartwatch', category: 'Wearables', price: 279.00, rating: 4.2, image: 'assets/img/watch.png', desc: 'Health tracking with AMOLED display and 7‑day battery life.', specs: ['AMOLED','GPS','SpO2','7‑day Battery','5ATM'] },
    { id: 'spk-pulse', name: 'Pulse Bluetooth Speaker', category: 'Audio', price: 89.50, rating: 4.1, image: 'assets/img/speaker.png', desc: 'Room‑filling sound, deep bass, and splash resistance.', specs: ['BT 5.0','IPX5','10h Battery','Stereo Pair'] },
    { id: 'drn-aero', name: 'AeroFold 4K Drone', category: 'Drones', price: 649.99, rating: 4.5, image: 'assets/img/drone.png', desc: 'Foldable 4K HDR drone with obstacle avoidance and long range.', specs: ['4K HDR','OAS','10km Range','28min Flight'] },
    { id: 'mon-27q', name: '27" QHD Pro Monitor', category: 'Monitors', price: 329.99, rating: 4.4, image: 'assets/img/monitor.png', desc: 'Crisp QHD panel with 99% sRGB and ergonomic stand.', specs: ['27" QHD','IPS 75Hz','99% sRGB','USB‑C 65W'] },
    { id: 'key-mech', name: 'Mecha RGB Keyboard', category: 'Accessories', price: 129.00, rating: 4.3, image: 'assets/img/keyboard.png', desc: 'Hot‑swappable mechanical keyboard with per‑key RGB.', specs: ['Hot‑swap','PBT','Tri‑mode','Gasket Mount'] },
    { id: 'mou-glide', name: 'Glide Pro Mouse', category: 'Accessories', price: 59.99, rating: 4.2, image: 'assets/img/mouse.png', desc: 'Ergonomic wireless mouse with precision sensor.', specs: ['26K DPI','BT + 2.4G','100h','USB‑C'] },
    { id: 'tab-11', name: 'SlateTab 11" Tablet', category: 'Tablets', price: 399.00, rating: 4.1, image: 'assets/img/tablet.png', desc: '11-inch entertainment tablet with quad speakers.', specs: ['11" 1200p','8GB RAM','128GB','Quad Speaker'] },
    { id: 'con-neo', name: 'Neo Game Console', category: 'Gaming', price: 499.00, rating: 4.8, image: 'assets/img/console.png', desc: 'Next‑gen console with ray tracing and instant resume.', specs: ['4K60','RT','1TB SSD','VRR'] },
    { id: 'rtr-ax', name: 'AX5400 Wi‑Fi 6 Router', category: 'Networking', price: 179.99, rating: 4.4, image: 'assets/img/router.png', desc: 'Tri‑band Wi‑Fi 6 with network security and app control.', specs: ['AX5400','Tri‑band','WPA3','OFDMA'] },
    { id: 'ssd-nv1', name: 'NV1 1TB NVMe SSD', category: 'Storage', price: 89.99, rating: 4.6, image: 'assets/img/ssd.png', desc: 'Fast NVMe storage for snappy loads.', specs: ['PCIe 3.0 x4','R: 2100MB/s','W: 1700MB/s'] },
    { id: 'pwb-20k', name: 'PowerBank 20,000mAh', category: 'Power', price: 49.99, rating: 4.0, image: 'assets/img/powerbank.png', desc: 'High capacity USB‑C PD portable charger.', specs: ['20,000mAh','USB‑C PD','2x USB‑A'] },
  ];
